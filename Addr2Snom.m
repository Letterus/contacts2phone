...
@interface Addr2Snom: OFObject <OFApplicationDelegate>
@end

OF_APPLICATION_DELEGATE(Addr2Snom)

@implementation Addr2Snom
...
-(ESource*)retrieveAdressbookSource
{
	...
	@try {
	    ...
	    if(err != NULL) {
	    	OFException *e = [OFException exception];
	        e.description = [OFString stringWithCString: err->message 
